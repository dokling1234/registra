          ...
          <div className="card">
            <div className="card-body">
              <p>
                ...
                computer engineering professionals and the motivator of
                interest towards excellence in computer engineering as a field
                of specialization.
              </p>
            </div>
          </div>
        ...
        <section id="history" className="mb-5 pt-5">
          ...
          <div className="card">
            <div className="card-body">
              ...
              <p>
                In 2008, computer engineers from different organizations, led
                by Engr. Erwin G. Mendoza and Engr. Alexander B. Ybasco, came
