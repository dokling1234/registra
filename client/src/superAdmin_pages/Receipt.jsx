                                ...
                                {registrant.paymentStatus === "pending" && (
                                  <div className="flex gap-2">
                                    <button
                                      ...
                                      className="bg-gradient-to-r from-green-500 to-green-400 text-white px-3 py-1 rounded-lg hover:from-green-600 hover:to-green-500 transition text-xs shadow"
                                    >
                                      Confirm
                                    </button>
                                    <button
                                      ...
                                      className="bg-gradient-to-r from-red-500 to-red-400 text-white px-3 py-1 rounded-lg hover:from-red-600 hover:to-red-500 transition text-xs shadow"
                                    >
                                      Reject
                                    </button>
                                  </div>
